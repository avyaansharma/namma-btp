...
ROOT_DIR = os.getcwd()
DIR = os.path.join(ROOT_DIR, 'sample_dataset', 'Fisheye8K_all_including_train&test')
TRAIN_ANNOTATION_PATH = os.path.join(DIR, 'train', 'annotations')
VAL_ANNOTATION_PATH = os.path.join(DIR, 'test', 'annotations')
